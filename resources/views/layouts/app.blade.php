...
<head>
    ...
    @endphp
    <style>
        /* No need for complex CSS variables if we simplify the approach */
        ...
        * {
        ...
        .sidebar {
            ...
            color: white;
            position: fixed;
            height: 100vh; /* Keep 100vh */
            overflow-y: auto; /* Keep auto for conditional scrolling */
            -webkit-overflow-scrolling: touch; /* For smooth iOS scrolling */
            /* Add this to hide the scrollbar track when not in use on Webkit browsers */
            overflow: -moz-scrollbars-none; /* Firefox */
            -ms-overflow-style: none;  /* Internet Explorer 10+ */
            scrollbar-width: none;  /* Firefox (standardized way) */
        }

        /* Webkit (Chrome, Safari, Edge) scrollbar styling for the sidebar */
        .sidebar::-webkit-scrollbar {
            width: 8px; /* Width of the scrollbar */
            background-color: transparent; /* Make the background of the track transparent */
        }
        ...
        .sidebar::-webkit-scrollbar-thumb {
            background-color: #5a6d81; /* Color of the scrollbar thumb */
            border-radius: 4px;
            border: 2px solid transparent; /* No border here, thumb will be flush */
        }

        .sidebar::-webkit-scrollbar-thumb:hover {
            background-color: #7b8b9b; /* Color when hovering over the thumb */
        }
        ...
        .user-section {
            ...
            /* Reduced margin-bottom from 1.5rem to 1rem based on image observation */
            margin-bottom: 1rem;
            position: relative;
        }
        ...
        .logo {
            display: flex;
            align-items: center;
            margin-bottom: 0rem; /* Keep as is */
            padding: 0.5rem; /* This padding adds to the logo area */
            color: white;
            /* Added margin-top to separate it slightly from the top edge if needed, or remove if padding is enough */
            margin-top: 0.5rem; /* Small adjustment for top spacing */
        }
        ...
        .nav-links {
            list-style: none;
            /* Reduced top margin for nav-links based on image to pull it up slightly */
            margin-top: 1rem;
        }
        ...
        /* Specific scrollbar styling for the client dropdown if it also scrolls */
